      ...
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-foreground/70 text-sm leading-relaxed">
              Empowering healthier futures through nutritional insights for children and teens.
            </p>
          </div>
          ...
          <div className="md:col-span-3 grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/resources" className="text-foreground/70 hover:text-primary text-sm transition-colors">
                    Resources
                  </Link>
                </li>
                <li>
        ...
        <div className="mt-12 pt-8 border-t border-border/40 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-foreground/60 text-sm">
            © {currentYear} NutriYouth. All rights reserved.
          </p>
